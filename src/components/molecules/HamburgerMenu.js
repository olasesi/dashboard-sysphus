...
function HamburgerMenu({ isclicked, handleClick }) {
  return (
    <>
      <div className="topbar__menu" onClick={handleClick}>
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
      ...
      {isclicked && (
        <ol className="hamburger-menu">
          <ol className="hamburger-menu__list">Exchange</ol>
          <ol className="hamburger-menu__list">Wallets</ol>
          <ol className="hamburger-menu__list">Roqqu Hub</ol>
          <ol className="hamburger-menu__list">Log out</ol>
        </ol>
      )}
    </>
  );
